...
const BLOCK_TYPES = {
    ...
    1: { name: 'Terre', color: '#5d4e37', solid: true, hardness: 0.5, minableWith: ['shovel', 'hand'] },
    ...
    6: { name: 'Feuilles', color: '#2e7d32', solid: false, hardness: 0.2, minableWith: ['shovel', 'hand', 'pickaxe', 'sword'] },
    ...
    11: { name: 'Torche', color: '#ffcc00', solid: false, hardness:0.2, light: true, minableWith: ['shovel', 'hand', 'pickaxe', 'sword'] },
